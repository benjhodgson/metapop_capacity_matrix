...
# Display
main_title = "Medium aggregation, Medium dispersal, 500% increase"
...
ggplot(plot_df_linear, aes(x = (habitat_cover), y = (difference), colour = (movement_ability))) +
  geom_point() +
  labs(title = "Medium aggregation, Medium dispersal, Delta linear 50%",
       x = "Habitat Cover", y = "Difference", color = "Movement Ability (% increase)") +
  theme_minimal()
...
main_title = "Medium aggregation, 500% increase, Delta linear 50%"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "High aggregation, Low dispersal,\n5000% increase, High colonisation/ low extinction constants"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "Low aggregation, Very low dispersal,\n 500% increase, High colonisation/ low extinction constants"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "Low aggregation, Very low dispersal,\n500% increase, Medium colonisation/ medium extinction constants"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "Low aggregation, Very low dispersal,\n500% increase, Low colonisation/ high extinction constants"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "Medium aggregation, Very low dispersal,\n5000% increase, High colonisation/ low extinction constants"
combined_plot + plot_annotation(title = main_title)
...
# Display
main_title = "High aggregation, Very low dispersal,\n5000% increase, High colonisation/ low extinction constants"
combined_plot + plot_annotation(title = main_title)
