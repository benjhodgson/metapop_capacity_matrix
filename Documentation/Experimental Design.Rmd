...
```{r extinction parameters, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(kableExtra)

extinction_df <- data.frame(
  Extinction = c("High extinction rate", "Medium extinction rate", "Low extinction rate"),
  "e" = c(0.5, 0.1, 0.01), check.names = FALSE
)

# Display Table 2
kable(extinction_df, caption = "Parameters for the extinction constant (e)")
```

```{r colonisation constant parameters, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(kableExtra)

colonisation_constant_df <- data.frame(
  Colonisation = c("High colonisation rate", "Medium colonisation rate", "Low colonisation rate"),
  "c at relative yield = 1" = c(0.5, 0.1, 0.01), check.names = FALSE
)

# Display Table 2
kable(colonisation_constant_df, caption = "Parameters for the colonisation constant (c) at relative yield = 1")
```
