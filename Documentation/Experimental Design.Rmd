...
df <- data.frame( "Dispersal / Aggregation" = c("**High Dispersal**", "**Medium Dispersal**", "**Low Dispersal**", "**Very Low Dispersal**"), "High Aggregation" = c("High agg/High disp", "High agg/ Mid disp", "High agg/ Low disp", "High agg/ V Low disp"), "Medium Aggregation" = c("Mid agg/ High disp", "Mid agg/ Mid disp", "Low agg/ Mid disp", "Mid agg/ V Low disp"), "Low Aggregation" = c("Low agg/ High disp", "Low agg/ Mid disp", "Low agg/ Low disp", "Low agg/ V Low disp"), check.names = FALSE)
...
dispersal_df <- data.frame(
  Configuration = c("High dispersal", "Medium dispersal", "Low dispersal", "Very low dispersal"),
  "Mean Dispersal Distance at Relative Yield = 1 (km)" = c(5, 1, 0.1, 0.01), check.names = FALSE
)
